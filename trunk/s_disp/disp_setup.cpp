// Time-stamp: <disp_setup.cpp - 18:23:55 16.04.2006>
/***********************************************************************
 ***         Реализация виджета по настройке дисперсии среды         ***
 ***********************************************************************/
...
float DispSetup::disp[4096] = {0, 0};
QString DispSetup::dispString = "";

// {{{ рисуем дисперсионную характеристику

// Рисуем дисперсионную характеристику
void DispSetup::drawDisp()
{
...
void DispSetup::drawVelocities(double x)
{
  // Выясняем координаты окрестности заданной точки
  double accuracy = 400.0;
